...
export default function CommunityPage() {
  return (
    <>
      <header className="gap-12 my-12 mx-auto w-[90%] max-w-[75rem] text-[#ddd6cb] text-center">
        <h1 className="font-montserrat text-4xl font-bold mb-3">
          One shared passion:{' '}
          <span className="mt-4 bg-gradient-to-r from-[#f9572a] to-[#ff8a05] bg-clip-text text-transparent">
            Food
          </span>
        </h1>
        <p className="text-lg">
      ...
      <main className="w-[90%] max-w-[40rem] mx-auto text-center">
        ...
        <ul className="list-none my-12 p-0">
          <li className="flex flex-col items-center gap-8">
            ...
            />
            <p className="font-montserrat text-lg font-bold text-[#ddd6cb] m-0">
